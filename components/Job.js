    ...
    return (
      <div className='mb-4 mt-20 pl-16 pr-16'>
        ...
        {isDashboard && job.published && (
          <span className='bg-white dark:bg-slate-800 text-white uppercase text-sm p-2 mr-1'>
            ✅ Published
          </span>
		    )}
		    {isDashboard && !job.published && (
          <span className='bg-white dark:bg-slate-800 text-white uppercase text-sm p-2 mr-5'>
            ❌ Unpublished
          </span>
		    )}
